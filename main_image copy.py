...
def get_args_parser():
    """
    a function to create and return a parser for command-line arguments
    """
...
def set_trainable_adapter(model, idx):
    """
    a function for *layer-wise iterative training*, to set the trainable adapter in each layer.
    """
